const questions = [
  ...
  //if an answer is selected before the timer is done it seems to have a bit of a freak out and tries to reset but also continue the previous count down. Need to find a way to stop countdown when an answer is selected
  function timer (){
    let time = 10;
